...
\l X_c^{+\kappa}.\boldsymbol{\l}\mathbb{I}^\kappa.
\forall X^\kappa.
(\forall X_r^\kappa. (X_r \karrow{\kappa} X_{\!F}\,X_c)
...
\In_\kappa &\triangleq
\l t. \l s. s\;\unIn_\kappa\;\textit{id}\;(\McvPr\;s)\;t \\
~\\
\unIn_\kappa &\;:~ \forall X_{\!F}^{+\kappa-> \kappa}.
	\mu^{+}_\kappa X_{\!F} \karrow{\kappa} X_{\!F}(\mu^{+}_\kappa X_{\!F})\\
\unIn_\kappa &\triangleq \\
\end{align*}
\end{singlespace}
\end{landscape}
