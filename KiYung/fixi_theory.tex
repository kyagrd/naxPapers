...
\KYA{TODO find and cite the work on logical consistencies of
        implicit calculus + equi-recursive types. I believe
	it is enough to point to the interpretation of types in Fixw paper
	and mention that the void type $\forall X^{+*}.X$ is uninhabited
...
For example, recall \texttt{fmap1} in \S\ref{sec:fixi:cv:unInExamples}.
