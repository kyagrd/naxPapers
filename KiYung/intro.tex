...
over term-indexed types, we establised theories of term-indexed types, which is
another major aspect of our contribution.

In addition, we developed better understanding of some existing Mendler-style
recursion schemes. For instance, the existence of Mendler-style couse-of-values
...
(\McvPr) into the lambda calculi, which can embed Mendler-style prmitive
recursion (\MPr).
