...
such as Curry--Howard corresponds, Mendler-style recursion schemes,
and term-indexed types.

\section{Preliminary concepts}\label{sec:intro:concepts}
In this section we summarize important ideas that for the foundation
for the new material we develop in the following chapters.
%% 
...
the computation of recursion schemes but their result can considered as same.
