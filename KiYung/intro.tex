...
(\eg, $\beta$-reduction, normal forms) and type theory (i.e., fmilair with
describing typing rules in the inference rule form). We also assume that
the readers understand basic concepts of logic (\eg, axioms, inference, and
proofs) but not necessary familiar with \emph{formal reasoning systems}.
...
know, the Curry--Howard correspondence already hold. In addition, there is
