...
express certain computations within the reasoning system, to achieve logical consistency.

As a result, the recursion schemes of programming languages and formal reasoning systems
differ considerably.
