...
\begin{itemize}
	\item
	Organized a heirarchy of recursion schemes
		by the abstract operations they support
	\item
	Expanded the realm of Mendler-style recursion schemes
	\begin{itemize}
		\item discovered new faimlies of recursion scheme
			by adding new abstract operations

		\item term-index types
	\end{itemize}
	\item aaaaaa
	\item aaaaaa
\end{itemize}
