...
The recursive type operator $\mu$ described in Figure \ref{fig:approaches},
...
\paragraph{Recursive types in Mendler-style approach.}
\index{Mendler-style}
...
towards a seamless unified system for both programming and reasoning. %% TODO footnote we have some recent updates on Mendler-style iteration over PHOAS
...
We provide examples that illustrate scenarios in which each recursion scheme is
...
\subsection{Contributions towards the Nax language design}
...
\index{Mendler-style}
\paragraph{Part \ref{part:Mendler} (Mendler style)}\hspace*{-.7em}
introduces
