...
We also have in mind that the foundational theory and
implementation framework for Nax should be kept simple.
...
dependent types can do using singleton types. Since we only have erasable
indices, the foundational theory can be kept simple and easier to support
features that have the merits of programming oriented systems.
