...
the erasure property. That is, strong normalization and logical consistency
of \Fi\ and \Fixi\ are inherited from \Fw\ and \Fixw.
Due to these properties, strong normalization and logical consistency,
