...
For example, we can define datatypes for natural numbers and lists
in two steps. First defining the structure (|N| and |L|),
and second taking the fixpoint with the type operator |Mu0|:
\begin{singlespace}
...
prelude function |take :: Int -> [a] -> [a]|
over Haskell lists. It does not have to worry about running out of
