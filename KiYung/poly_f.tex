...
such as the void type $\iota$ in STLC. In System \F, we can populate types from
forall types such as $\forall X.X$. This this type is, in fact, an encoding of
the void type. We can encode large class of datatypes in System \F
(\S\ref{sec:f:data})
