...
& eliminator		& $\l x.\l x_1. \l x_2. x\;x_1\,x_2$  %% if $t$ then $s_1$ else $s_2$ $t~s_1~s_2$
	\\\hline
pair
...
& eliminiator		& $\l x.\l x_1. \l x_2. x\;x_1\,x_2$ %% case $t$ of \{Inl $x -> s_1\,x$; Inl $x -> s_2\,x$\} $t\,s_1\,s_2$
	\\\hline
natural
