...
is the \rulename{RedBeta} rule. Proof for all the other rules are simply done
by applying the induction hypothesis. Proof for the \rulename{RedBeta} rule
...
Strong normalization \KYA{
TODO it is worth discussing some details of the normalization proof
since we are going to do similar thing over and over with growing complexity}
