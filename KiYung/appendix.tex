...
\chapter{TODO Type Inference in Nax}
aaaaaaaaaaaaaaaa\\
...
& \inference[\sc TApp]{\Delta |- F : \kappa -> \kappa' & \Delta |- G : \kappa}
                      {\Delta |- F ~ G : \kappa'} \\
\end{align*}
\[ \textbf{Type scheme ordering (or, generic instantiation)} \quad
   \framebox{$\sigma \sqsubseteq_\Delta \sigma'$} \]
\[
 \inference[\sc GenInst]{
...
& \inference[\sc Con$_s$]{C:\sigma \in \Gamma & \sigma \sqsubseteq_\Delta A}
                         {\Delta;\Gamma |-s C:A} \\
& \inference[\sc Case]{ \Delta;\Gamma |- s : A \\
                        \Delta;\Gamma |-^\psi \varphi : A -> B
                      }{\Delta;\Gamma |- \<case>_{\!\!\psi}\;s\<of>\varphi:B} &
& \inference[\sc Case$_s$]{
                       \Delta;\Gamma |-s s : A \\
                       \Delta;\Gamma |-s^\psi \varphi : A -> B
                     }{\Delta;\Gamma |-s \<case>_{\!\!\psi}\;s\<of>\varphi:B} \\
& \qquad\framebox{$\Delta;\Gamma |-^\psi \varphi : \sigma$} &
& \qquad\framebox{$\Delta;\Gamma |-s^\psi \varphi : A$} \\
& \inference[\sc Branches]{
              \overline{\Delta;\Gamma |-^\psi C\overline{x} ->t : \sigma}
            }{\Delta;\Gamma |-^\psi \overline{C\overline{x} -> t} : \sigma } &
& \inference[\sc Branches]{
              \overline{\Delta;\Gamma |-s^\psi C\overline{x} ->t : \sigma} \\
              \sigma \sqsubseteq_\Delta A
            }{\Delta;\Gamma |-^\psi \overline{C\overline{x} -> t} : A } \\
& \inference[\sc Inst$'$]{ \Delta;\Gamma |-s^\psi \varphi : \sigma
                       & \sigma \sqsubseteq_\Delta \sigma'
                       }{\Delta;\Gamma |-^\psi \varphi : \sigma'} &
& \\
