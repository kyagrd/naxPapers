...
(\eg, $\beta$-reduction, normal forms), but not necessary familiar
with \emph{logical reasoning} in \emph{reasoning systems}.
...
\begin{array}{ccc}
	...
	\text{Typing rules of lambda calculus} \\ \\
...
The terms in the typing rules of lambda calculus reflects
