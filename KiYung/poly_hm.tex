...
Note, the completeness of $|-s$ is to be stated in terms of closure and
...
\end{theorem}
\begin{proof}
TODO by induction on the derivation

when the last rule is
...
Inst by induction and transitivity of $\sqsubseteq$
