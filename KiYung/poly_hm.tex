...
However, the let-term does make a significance in the typing rules.
...
means that $\sigma$ is more general than or equivalent to $\sigma'$.
...
a special case of the type scheme ordering rule in Figure \ref{fig:hm},
...
except the free variables in $\Gamma$. The free variables of $\Gamma$ is
