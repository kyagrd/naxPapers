...
a unified language useful for both purposes. Programming languages usually
extend lambda calculi with programming friendly features
(\eg, recursive datatypes, general recursion) for the flexibility to
...
which balances between the benefits of the both. Nax accepts
all recursive datatypes, allowing the same flexibility of defining
recursive datatypes in functional languages. Nax supports
...
term-indexed types to enable specifications of fine-grained properties.
