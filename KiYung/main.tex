...
Two mayjor applications areas of \emph{type theory} in computer science are
programming languages and mechanized reasoning systems. In this dissertation,
we consider intuitionistic type theoy in the context of lambda calculi.

Lambda calclui has been studied as a theoreical prototype of functional
programming languages. Studies on typed lambda calclui lead to clearer
understnadings on \emph{type safty} of functional programming languages.
In computer science education, one is more likely to be primarily exposed to
the computational aspect of lambda calcui.

Church originally invented lambda calcui as a foundation of logic. That is,
to use the lambda calculus as a rigourous meta-language to formally describe
concepts (\eg, mathematical definitions) and formally reason about them
(\ie, prove theorems).

its orignial foundation of mathematics
...
core of
serves as a trusted base.

foundation of formal proofs
understaning of 
It is especially . 
studies on typed lambda calculi.
calculi Theoretical
basis of
typed functional programming languages

how to support datatypes
