...
sure that type variables are bound in the context.
...
are illustrated in Figure \ref{fig:fw}. We consider only
the Curry-style term syntax for System \Fw. Since lambda binders exist
at both the term- and the type-levels in System \Fw, we also have a choice of
