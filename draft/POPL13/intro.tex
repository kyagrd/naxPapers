...
\section{From System~\Fw\ to System~\Fi, and back}%{Motivation}
\label{sec:motiv}
...
also keep track of indexing invariants.  Being static, all term-indexing
...
Section~\ref{sec:theory} and used to deduce the strong normalization of
System~\Fi.
