...
\item[case] ($@$)
	By induction, easy.
\item[case] ($\lambda i$)\\
	By induction and Proposition~\ref{prop:wftype} 
\marginpar{\fbox{\bf\em Why Prop.~\ref{prop:wftype}?}}
	we know
	that $\cdot|- A:*$.
...
$ \inference{\Delta;\Gamma,x:A |- t:B & \Delta;\Gamma |- s:A}
	{\Delta,\Gamma |- t[s/x]:B} $
\marginpar{\framebox{\bf\em Added a $\Gamma$ here}}
%\end{lemma}
\end{enumerate}
\end{lemma}
...
We define a meta-operation of index erasure that projects $\Fi$-types to
$\Fw$-types.
...
\]
\marginpar{\framebox{\bf\em Modified last case}}
\end{definition}\noindent
