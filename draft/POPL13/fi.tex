...
in the $(\forall I)$ rule is not necessary since such a condition
is already a part of the well-formedness condition for the single context
...
type level, \ie, where it does not affect reduction at term level.
...
\subsection{The constructs new to \Fi} \label{ssec:newFi}
