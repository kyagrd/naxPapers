...
reduction. For instnace, the Church-Rossor property naturally holds for all
of $\beta$-, $\eta$-, and $\beta\eta$-reduction in Curry style, but
it does not hold Church style due to the presense of annotations on
abstractions \cite{TODO ICC ECC}.\footnote{Does not hold in the strict sense
	(\ie, $\alpha$-equivalence over Church-style terms),
	but may hold under certain approximation such as
	modulo ignoring the annotations on abstractions.}
