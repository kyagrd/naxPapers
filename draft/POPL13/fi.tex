...
Annotating the type level abstractions with kinds just makes it more evident
about kinds in the type syntax. As a notational convention, we write
...
which do not contain any free type variables or index variables.
...
$A$ must be closed type without free variables.
