...
logically consistency (in Curry--Howard sense) like formal proof assistants
...
term-indices in Nax is as pleasant as in Haskell and Agda, while enjoing
the merits of both. We also discuss strengths and limitations of the Nax
appraoch to indexed types.
