...
\begin{align*}
\hat\cdot                 &=~ \cdot                &~~~~ \overline\cdot             &=~ \cdot                       \\
\widehat{\Delta,x:A}      &=~ \hat\Delta           &~~~~ \overline{\Delta,x:A}      &=~ \overline\Delta             \\
\widehat{\Delta,X^\kappa} &=~ \hat\Delta,X^\kappa  &~~~~ \overline{\Delta,X^\kappa} &=~ \overline\Delta             \\
\widehat{\Delta,x^A}      &=~ \hat\Delta,x::A      &~~~~ \overline{\Delta,x^A}      &=~ \overline\Delta             \\
\widehat{\Delta,x::A}     &=~ \hat\Delta,x::A      &~~~~ \overline{\Delta,x::A}     &=~ \overline\Delta,x::A
\end{align*}
\end{minipage} }
...
\newFi{\lambda x^A.F} is the type level lambda abstraction over an index.
This construct introduces indexed arrow kinds by the kinding rule
\newFi{(\lambda i)}. In the $(\lambda i)$ rule, a new form of binding
...
\newFi{F\,\{s\}} is the type level index application.
...
\newFi{\forall x^A . B} is an index polymorphic type. The formation of
...
\newFi{\Delta, x^A} is a typing context $\Delta$ extended by an index binding
$x^A$. An index binding is introduced from $\lambda x^A.F$ by the kinding rule
\newFi{(\lambda i)}. Intuitively $x^A$ means that $x$ can only be used
