...
\begin{figure}
\begin{framed}
\paragraph{Kind equality:} \fbox{$\Delta |- \kappa=\kappa' : \square$}
...
\[ \inference{ |- \Delta & \Delta |- F : \kappa}{ \Delta |- \kappa }
\]
\end{proposition}
...
\[ \inference{ |- \Delta
             & \Delta |- \lambda X^\kappa . F : \kappa \to \kappa' }
             { X\notin\FV(\kappa') }
\]
\end{proposition}
...
\[ \inference{ |- \Delta
             & \Delta |- \lambda i^A . F : A \to \kappa }
             { i\notin\FV(\kappa) }
\]
\end{proposition}

\begin{proposition}[static context irrelevance of sorting]
\[ \inference{ |- \Delta & \Delta |- \kappa : \square }
             { \cdot |- \kappa : \square }
\]
\end{proposition}
