...
TODO the first case is done by induction and appyling the equality rule again.

TODO the second case is done by induction and the fact that $([s/i]F)^\circ = F^\circ$
\end{proof}
