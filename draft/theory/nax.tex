...
\[ \inference[($\Sigma,T$)]
      ...
      { \Sigma |- \mathbf{data}~ T : \kappa ~ \mathbf{where} ~
                  \overline{C : \overline{A} -> T\,\overline\tau }
               ~\Rrightarrow~
                  \Sigma,T:\kappa
...
$T:\kappa$ is the type constructor binding.

$C:\sigma$ is the data constructor binding.

$`x:\sigma$ is the top level variable binding.
...
($\mathbf{data}~T:\kappa~\mathbf{where}~\dots$) and recursive type operators
