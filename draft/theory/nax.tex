...
% (case branches laid out as multiple lines for better readability):
\[
\begin{pmatrix}
...
Mendler style iterators ($\<MIt> x.\varphi^\psi$) TODO.
...
TODO % discuss about top level definitions as well
