...
\]
~\\
$\phantom{A}$ First two rules of type constructor equality rules
and the first rule of the term equality rules
state the essence of $\beta$-equivalence.
Last two rules in each set of Kind/Type/Term equality rules
state symmetric and transitive nature of the equalities.
