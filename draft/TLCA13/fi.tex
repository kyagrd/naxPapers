...
\]
~\\
Many typing judgments require determining if two types are equal.
Since types occur in kinds, and terms occur in types, the rules
for equality are quite complex.

$\phantom{A}$ The first two rules of type constructor equality,
