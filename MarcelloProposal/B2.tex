...
dependent products may be intensional (under $\beta$ equality) or extensional
(under $\beta\eta$ equality). 
%---see \eg~\cite{?}.
...
\item[{\bfseries 2\enspace Models:}]\mbox{}\enspace\thinspace
  ...
  forefront of current understanding, specifically for 
  \marginpar{\color{red}REVISE}
  intensional type theory and polarised logic.
