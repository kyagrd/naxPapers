...
Martin-L\"of); and it is currently central to research in programming
...
In this vein, the aim of the proposed research is:
\begin{myitemize}
\item[$\star$]
...
was introduced to overcome such foundational problems --- typed systems
...
seems to be emerging.  This will be also referred to as the calculus or
system~\SysL; and underlies the ones developed
