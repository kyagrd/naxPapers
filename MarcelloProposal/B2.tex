...
The reasons and motivations for our %research 
...
\end{myitemize}
Towards these goals, Principal Investigator Marcelo Fiore has conceived
the research programme of this proposal, expanding through
metamathematical foundations, mathematical models, computational calculi,
...
%(such as Agda). 
In this field, he has made several fundamental contributions, especially
to Martin-L\"of's Intuitionistic Type Theory.  
...
%
$(iv)$~his powerful notion of an inductive-recursive definition, 
that %It extends the notion of an inductive definitions and 
is useful for understanding universes and reflection principles in type
theory 
...
Dybjer is also a member of the team at Chalmers which develops the
dependently typed programming language (and proof assistant) Agda.  He is
the initiator of the biannual Agda implementors meetings.
