...
started developing in the 1970s, with proponents from computer science
(\eg~Dijkstra, Hoare, Strachey) and from mathematics (\eg~de Bruijn, Scott,
Martin-L\"of); and is currently central to research in programming languages
...
unified whole, have shaped fields of computer science and mathematics.
\hide{
...
The reasons and motivations for our proposal are specifically as follows:
\begin{myitemize}
\item[\raisebox{.75mm}{\tiny$\bigstar$}]\hspace*{-1.5mm}
...
\end{myitemize}
To these ends, Principal Investigator Marcelo Fiore has drawn the research
programme of this proposal, expanding through metamathematical
foundations, mathematical models, computational calculi, and programming
languages.  
%
%{\erc} assembles a world-leading team of theoretical and applied computer
%scientists:  Principal Investigator Marcelo Fiore; Senior Visiting Researchers
%Pierre-Louis Curien, Peter Dybjer, and Tim Sheard; and Research Associates Ki
%Yung Ahn, Nicola Gambino, and Guillaume Munch-Maccagnoni.  
...
\\
  \fbox{\txt{\small Type\\\quad\small Theory\quad\null}}
\ar@/_1em/@{<->}[rr]|-
  {\txt{\scriptsize Formal\\\scriptsize Languages}}
& & 
\fbox{\txt{\small Programming\\\small Theory}}
}
\end{center}
...
outlines the origins and influences that led to the holistic conception of
Figure\,\ref{ResearchAreas}. 
...
\item
  ...
  computational languages with effects and rich type structures through
...
Curien has been following developments in the areas of higher-dimensional
category theory and algebraic operads; and he 
...
%\end{tabular}}
%
is Professor and Head of the Division of Computing Science in the Department
of Computer Science at Chalmers University of Technology.
{\color{red}REVISE}

Dybjer's main field of research is Type Theory, including its connections 
with Logic and Category Theory, and its implementation in Proof Assistants 
such as Agda. He has made several fundamental contributions to type theory, 
especially Martin-L\"of's intuitionistic type theory.

Several of these contributions are directly relevant to this proposal, for 
example, his exploration of the syntax and semantics of Inductive Families 
in Type Theory. He has made several contributions directly relevant to the 
present proposal of direct relevance to the present proposal.

He has made several contributions of direct relevance to the present proposal, 
for example on Categorical Semantics of Type Theory. For example, he invented 
the notion of a Category with Families, a categorical notion of model of 
dependent types with a close connection to the syntax of the theory. He also 
discovered the new powerful notion of an inductive-recursive definition. It 
extends the notion of an inductive definitions and is useful for understanding 
universes and reflection principles in Type Theory. Dybjer has (together with 
Setzer) proved a general result about the correspondence between 
inductive-recursive definitions and initial algebras. Moreover, he has recently 
(together with Clairambault) proved the biequivalence between Martin-Löf type 
theory and locally cartesian closed categories, thereby correcting the 
well-known, but erroneous, result by Seely of the equivalence of these theories.

Dybjer is also one of the main contributors to the technique of normalization 
by evaluation, a new approach to normalization in logic and lambda calculus. 
This technique is attractive both from a theoretical and practical point of view, 
and has interesting connections with Categorical Semantics.

Dybjer is also a member of the team at Chalmers which develops the dependently 
typed programming language (and proof assistant) Agda. He is the initiator of 
the biannual Agda implementors Meetings.
...
work~\cite{AhnSheard11}, supported by U.S.~National Science Foundation
grant~0910500, on Mendler-style recursion schemes.
...
\begin{myitemize}
\item
Travel funding is requested for attending meetings (conferences,
workshops,~\etc),\hidefootnote{\Eg~CALCO, CIE, CSL, CT, ICALP, ICFP, LICS,
  MFPS,  POPL, PPDP, PSSL, RTA, TLCA, TYPES, WOLLIC.}{} 
and for visiting and inviting researchers. \hidefootnote{\Eg~Aarhus
  (A\,Kock); 
  Bamberg (Mendler);
  Barcelona (J\,Kock);
  Bath (Power); 
