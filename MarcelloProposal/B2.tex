...
The general aim of the project %{\erc} 
is to build a group dedicated to combined research in Category Theory,
...
%
To this end, {\erc} assembles an international team of world-leading experts
in each of the project research areas.  
...
Omega, which pioneered the use of GADTs\cite{ONWARD,sheardLFM04} and indexed types
(the theory of which is discussed in section {\bf b-4.i} and on which the new language Nax is based). These features
...
\newblock OOPSLA Companion Volume.
...
\newblock {\em ACM SIG{\-}PLAN Notices}, 37(12):60--75, December 2002.
