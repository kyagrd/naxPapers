...
in this context.  Each of them is complementary to the others.  Together, they
have shaped fields of logic and computation as a unified whole.  Indeed,
consider for instance that: \ldots {\color{red}FINISH}

It is within the above framework that we propose cross-cutting research in
Category Theory, Mathematical Logic, Programming Theory, and Type Theory.  We
contend that an approach neglecting any one of them is to the detriment of the
others, missing the depth and richness of the subject and, furthermore,
missing opportunities for research and development.  

\ldots {\color{red}FINISH} \ldots
...
Section\pref{Origins} outlines the origins and influences that led to the
holistic Figure\,\ref{ResearchAreas}. 
...
to pursue and the {\erc} team we have assembled to reach them.  Both of
these points are further expounded upon in
...
\newblock Shared subtypes: subtyping recursive parametrized algebraic data types.
