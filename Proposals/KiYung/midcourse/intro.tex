...
we are designing a simple and expressive language called Nax, whose semantics
is closely related to \Fi\ (in fact, it can be defined in terms of \Fi), but whose
...
family. The features of \Fixi\ are outlined in \S\ref{sec:Fixi}.
